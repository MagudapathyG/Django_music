    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('album', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='musicportal.album', verbose_name='Song Album')),
            ],
            options={
                'verbose_name': 'Song',
        ...
        migrations.AddField(
            model_name='album',
            name='artist',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='musicportal.artist', verbose_name='Artist Album'),
        ),
    ]
